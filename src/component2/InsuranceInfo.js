...
const InsuranceInfo = ({ handleChangeIndex, handleReduceIndex, register, errors, trigger }) => {
        ...
        return ( <
                ...
                type = "radio"
                name = "PrimaryInsurer"
                value = "yes" {...register("PrimaryInsurer", { required: true }) }
                /> <
                ...
                type = "radio"
                name = "PrimaryInsurer"
                value = "No" {...register("PrimaryInsurer", { required: true }) }
                /> <
                label className = "form-check-label"
                htmlFor = "No" > No < /label> <
                /div>
                ...
                /div> {
                    errors.PrimaryInsurer && < div className = "error" > This field is Required < /div>}                   {
                            (Primaryinsurance === "yes") ? < > < h3 > Primary insurance Information < /h3> <
                                ...
                                <
                                label htmlFor = "Primary insurance carrier's name"
                            className = "form-label" > Primary insurance carrier 's name</label> <
                                input type = "text"
                            className = "form-control" {...register("PrimaryInsurerName", { required: true }) }
                            /> {
                                ...
                                placeholder = "First" {...register("PolicyHolderFName", { required: true }) }
                                />

                                <
                                input type = "text"
                                className = "form-control mx-2"
                                placeholder = "Last" {...register("PolicyHolderLName", { required: true }) }
                                /> <
                                /div> {
                                    ...
                                    type = "radio"
                                    name = "relation"
                                    value = "Parent" {...register("RelationWithPolicyHolder", { required: true }) }
                                    /> <
                                    label className = "form-check-label"
                                    htmlFor = "parent" > Parent < /label></div >
                                    ...
                                    type = "radio"
                                    name = "relation"
                                    value = "sibling" {...register("RelationWithPolicyHolder", { required: true }) }
                                    /> <
                                    label className = "form-check-label"
                                    htmlFor = "sibling" > Sibling < /label> <
                                        /div>
                                    ...
                                    type = "radio"
                                    name = "relation"
                                    value = "Child" {...register("RelationWithPolicyHolder", { required: true }) }
                                    /> <
                                    label className = "form-check-label"
                                    htmlFor = "Child" > Child < /label> <
                                        /div>
                                    ...
                                    type = "radio"
                                    name = "relation"
                                    value = "Friend" {...register("RelationWithPolicyHolder", { required: true }) }
                                    /> <
                                    label className = "form-check-label"
                                    ...
                                    type = "radio"
                                    name = "relation"
                                    value = { newrelation } {...register("RelationWithPolicyHolder", { required: true }) }
                                    /> <
                                    label className = "form-check-label"
                                    htmlFor = "sahil" > < input value = { relation }
                                    onChange = {
                                        (e) => (newrelation = setRelation(e.target.value)) }
                                    type = "text" / > < /label> <
                                        /div> <
                                        /div> {
                                            ...
                                            name = "Date" {...register("PolicyDateOfBirth", { required: true }) }
                                            /> {
                                                errors.PolicyDateOfBirth && < div className = "error" > Date of Birth is required. < /div>} <
                                                    ...
                                                    <
                                                    label htmlFor = "exampleFormControlInput1"
                                                className = "form-label" > Group / MemberID# < /label> <
                                                    input type = "text"
                                                className = "form-control"
                                                placeholder = "Group.."
                                                name = "group" {...register("PrimaryMemberID", { required: true }) }
                                                /> {
                                                    errors.PrimaryMemberID && < div className = "error" > Group# is required. < /div>} <
                                                        ...
                                                        <
                                                        label htmlFor = "exampleFormControlInput1"
                                                    className = "form-label" > Policy# < /label> <
                                                        input type = "text"
                                                    className = "form-control"
                                                    placeholder = "Policy.."
                                                    name = "policynumber" {...register("PrimaryPolicyNumber", { required: true }) }
                                                    /> {
                                                        ...
                                                        onChange = {
                                                                (e) => setSecondaryInsurance(e.target.value) } >
                                                            <
                                                            div className = "col" >
                                                            <
                                                            div className = "form-check form-check-inline" >
                                                        ...
                                                        type = "radio"
                                                        name = "yes"
                                                        value = "yes" {...register("SecondaryInsurer", { required: true }) }
                                                        /> <
                                                        label className = "form-check-label"
                                                        htmlFor = "yes" > yes < /label> <
                                                            /div> <
                                                        ...
                                                        type = "radio"
                                                        name = "No"
                                                        value = "No" {...register("SecondaryInsurer", { required: true }) }
                                                        />
                                                                ...
                                                                errors.SecondaryInsurer && < div className = "error" > Do you have a second insurance carrier ? is required ? < /div>} <
                                                                    ...
                                                                    /div> {
                                                                        (Secondaryinsurance === "yes") ? < > < h3 > Secondary insurance Information < /h3> <
                                                                            ...
                                                                            <
                                                                            label htmlFor = "Primary insurance carrier's name"
                                                                        className = "form-label" > Secondary insurance carrier 's name</label> <
                                                                            input type = "text"
                                                                        className = "form-control" {...register("SecondaryInsurerName", { required: true }) }
                                                                        /> {
                                                                            ...
                                                                            className = "form-control"
                                                                            placeholder = "Group.."
                                                                            name = "SecodaryGroup" {...register("SecondaryInsurerGroupID", { required: true }) }
                                                                            /> {
                                                                                ...
                                                                                className = "form-control"
                                                                                placeholder = "Policy.."
                                                                                name = "Secondarypolicy" {...register("SecondaryInsurerPolicy") }
                                                                                /> {
                                                                                ...
                                                                                />:<div className="col-md-5 mb-3"> <
                                                                                label htmlFor = "exampleFormControlInput1"
                                                                                className = "form-label" > Drivers license < /label> <
                                                                                    input type = "text"
                                                                                className = "form-control"
                                                                                placeholder = "Policy.."
                                                                                name = "Secondarypolicy" {...register("DriversLicense", { required: true }) }
                                                                                /> {
                                                                                ...
                                                                                onClick = {
                                                                                        () => { handleReduceIndex() } } > Back < /button> <
                                                                                    button type = "button"
                                                                                className = "btn btn-lg btn-primary mt-2 mx-5"
                                                                                onClick = {
