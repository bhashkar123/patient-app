    ...
    let content = < div > { /**/ } {
            isAuth ? ( < TopMenu isAuth = { isAuth }
...

                    {
                        ...
                        component = { Pages.Provider }
                        /> <
                        Route exact path = '/care-coordinator'
                        ...
                        /> <
                        Route exact path = '/thresold'
                        component = { Pages.Thresold }
                        /> <
                        Route exact path = '/patient-summary/:patient'
                        component = { Pages.PatientSummary }
                        /> <
                        Route exact path = '/patient-profile/:patient'
                        ...
                        to = "/patients" / >
                            ...
                            /Switch> <
                            /Router> <
                            /div> </React.Fragment >: < div className = "col-md-12" >
                            <
                            Router >
                            <
                            Switch >
