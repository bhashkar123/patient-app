        ...
        <div className='container'>
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-title mx-auto"><h5><Badge variant="success">Enter your email and password reset code will sent to you!</Badge></h5></div>
                        <div className="card-body">
                            <Form autoComplete='off' onSubmit={handleSubmit(login)} noValidate>
                                ...
                                <Input blockButton={true} value='Send' elementType='button' variant='primary' />
                                <br />
                                <center> {coreContext.renderLoader()}</center>
                                <center> <Input variant='danger' label={coreContext.message} elementType='label' /></center>
                                <br />
                                <br />
                                <center><a href="login"> Remember it ? Sign in here </a> </center>
                                <br />
                                <br />
