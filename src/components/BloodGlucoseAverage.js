...
const BloodGlucoseAverage = props => {
    ...
    let avgData=[];
    let newrows=coreContext.bloodglucoseData.map((curr)=>curr.UserName).filter((item, i, ar) => ar.indexOf(item) === i)
    ...
    const getReading=(value)=>{
        ...
        { 
            if (curr.UserName===value && new Date(curr.CreatedDate)>new Date(bfr)&&curr.reading!==undefined){
    ...
    const getBloodglucosemmol=(value)=>{
        ...
        { 
            //console.log(curr)
            if (curr.UserName===value && new Date(curr.CreatedDate)>new Date(bfr) &&curr.bloodglucosemmol!==undefined){
             //  (curr.UserName==='Jaypal')? console.log(curr,curr.bloodglucosemmol):null
             
             
                averagebloodglucosemmol=averagebloodglucosemmol+Number(curr.bloodglucosemmol);
                record=record+1
        }
    }
         )
    ...
    const getBloodglucosemgdl=(value)=>{
        ...
        coreContext.bloodglucoseData.map((curr)=>
        { 
            if (curr.UserName===value && new Date(curr.CreatedDate)>new Date(bfr)&&curr.bloodglucosemgdl!==undefined){
                averagebloodglucosemgdl=averagebloodglucosemgdl+Number(curr.bloodglucosemgdl);
                record=record+1
        }
    }
         )
