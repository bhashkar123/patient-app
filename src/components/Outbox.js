  ...
  const renderOutboxMessages = () => {
    if (coreContext.outbox.length > 0) {
      return coreContext.outbox.map((message) => {
        return (
          <div style={{ fontSize: 12, lineHeight: 0.5 }} className="card mb-4">
            <div className="card-header">
              ...
              <span
                ...
                onClick={() =>
                  fetchThreadMessages("to", message.to, message.patient_name)
                }
                className="mr-4">
                {message.patient_name}
              </span>{" "}
              <span style={{ fontSize: 8 }}>Time : {message.date.date}</span>
            </div>
            <div
  ...
  return (
    <div className="row">
      <div className="col-md-7 card shadow p-3 mb-5 bg-white rounded">
        <div className="card-body">{renderOutboxMessages()}</div>
      </div>
      <div
